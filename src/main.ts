...
function renderTaskStats() {
  getTaskStats()
    .then((stats) => {
      const container = document.getElementById("task-stats") as HTMLDivElement;
      container.innerHTML = `
      <div class="stat-card">
...
function renderUsers() {
  const container = document.getElementById("user-container") as HTMLDivElement;
...
function renderUserStats() {
  getUserStats()
    .then((stats) => {
      const container = document.getElementById("user-stats") as HTMLDivElement;
      container.innerHTML = `
      <div class="stat-card">
...
async function renderTags() {
  ...
  const list = document.getElementById("tag-list") as HTMLUListElement;
  list.innerHTML = tags
    .map(
      (tag) => `
    <li class="task-item">
...
async function handleSaveEditTask() {
  ...
  const title = (
    document.getElementById("edit-task-title") as HTMLInputElement
  ).value.trim();
  const category = (
    document.getElementById("edit-task-category") as HTMLInputElement
  ).value.trim();
  const done = (document.getElementById("edit-task-done") as HTMLInputElement)
    .checked;
...
async function handleAddUser() {
  ...
  const warning = document.getElementById("user-warning") as HTMLDivElement;
...
async function handleSaveEditUser() {
  ...
  const name = (
    document.getElementById("edit-user-name") as HTMLInputElement
  ).value.trim();
  const email = (
    document.getElementById("edit-user-email") as HTMLInputElement
  ).value.trim();
  const active = (
    document.getElementById("edit-user-active") as HTMLInputElement
  ).checked;
...
function openEditTask(
  ...
  (document.getElementById("edit-task-id") as HTMLInputElement).value =
    String(id);
  (document.getElementById("edit-task-title") as HTMLInputElement).value =
    title;
  (document.getElementById("edit-task-category") as HTMLInputElement).value =
    category;
  (document.getElementById("edit-task-done") as HTMLInputElement).checked =
    done;
...
function openEditUser(
  ...
  (document.getElementById("edit-user-id") as HTMLInputElement).value =
    String(id);
  (document.getElementById("edit-user-name") as HTMLInputElement).value = name;
  (document.getElementById("edit-user-email") as HTMLInputElement).value =
    email;
  (document.getElementById("edit-user-active") as HTMLInputElement).checked =
    active;
...
async function handleSearchTasks() {
  try {
    const search = (
      document.getElementById("task-search-input") as HTMLInputElement
    ).value.trim();
...
async function handleSearchUsers() {
  try {
    const search = (
      document.getElementById("user-search-input") as HTMLInputElement
    ).value.trim();
...
// Events — task list
  document.getElementById("task-list")!.addEventListener("click", async (e) => {
    ...
    if (target.classList.contains("task-checkbox")) {
      console.log("checkbox clicada!", target.dataset.id, (target as HTMLInputElement).checked);
